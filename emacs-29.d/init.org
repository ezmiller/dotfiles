    ...
    (use-package org-journal
      ...
      (general-define-key
        ...
        :config
              ...
              ;; Remove the automatic date heading entirely (date is already in TITLE)
              ;; Use a space to satisfy org-journal's validation while not displaying anything
              (setq org-journal-date-format " ")
              ;; Set entries to top-level headings (*)
